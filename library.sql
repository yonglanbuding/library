...
CREATE TABLE `book_info`  (
  `book_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '图书号',
  `name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '书名',
  `author` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '作者',
  `publish` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '出版社',
  `ISBN` varchar(13) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'ISBN',
  `introduction` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '简介',
  `language` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '语言',
  `price` decimal(10, 2) NOT NULL COMMENT '价格',
  `pubdate` date NULL DEFAULT NULL COMMENT '出版日期',
  `class_id` int(0) NULL DEFAULT NULL COMMENT '分类号',
  `pressmark` int(0) NULL DEFAULT NULL COMMENT '书架号',
  `state` smallint(0) NULL DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`book_id`, `name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 50000013 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `book_info` VALUES (50000011, '秘密花园', '乔汉娜·贝斯福 ', '北京联合出版公司', '9787550252585', '欢迎来到秘密花园！ 在这个笔墨编织出的美丽世界中漫步吧 涂上你喜爱的颜色，为花园带来生机和活力 发现隐藏其中的各类小生物，与它们共舞 激活创造力，描绘那些未完成的仙踪秘境 各个年龄段的艺术家和“园丁”都可以来尝试喔！', '中文', 42.00, '2015-06-01', 9, 18, 0);
INSERT INTO `book_info` VALUES (50000012, '秋刀鱼', '甘', '广应科', '202110005200', '牛逼', '中文', 30.00, '2012-01-12', 1, 12, 12);
...
CREATE TABLE `class_info`  (
  `class_id` int(0) NOT NULL COMMENT '分类号',
  `class_name` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '分类名',
...
CREATE TABLE `lend_list`  (
  `sernum` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '流水号',
  `book_id` bigint(0) NOT NULL COMMENT '图书号',
  `reader_id` int(0) NOT NULL COMMENT '读者卡号',
  `lend_date` date NULL DEFAULT NULL COMMENT '借出日期',
  `back_date` date NULL DEFAULT NULL COMMENT '归还日期',
  PRIMARY KEY (`sernum`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2017090202 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of lend_list
-- ----------------------------
INSERT INTO `lend_list` VALUES (1, 50000012, 170601000, '2023-12-11', '2023-12-11');
INSERT INTO `lend_list` VALUES (2, 10000001, 1706010217, '2017-03-15', '2017-06-16');
INSERT INTO `lend_list` VALUES (3, 50000004, 1706010217, '2017-03-15', '2017-09-03');
INSERT INTO `lend_list` VALUES (4, 10000003, 1706010218, '2017-06-10', '2017-09-02');
INSERT INTO `lend_list` VALUES (5, 10000006, 1706010219, '2017-06-12', '2017-09-02');
INSERT INTO `lend_list` VALUES (6, 50000005, 1706010219, '2017-06-15', NULL);
INSERT INTO `lend_list` VALUES (7, 50000010, 1706010218, '2017-06-15', NULL);
INSERT INTO `lend_list` VALUES (8, 10000001, 1706010220, '2017-09-02', '2017-09-02');
INSERT INTO `lend_list` VALUES (9, 50000011, 170601000, '2023-12-12', '2023-12-12');
INSERT INTO `lend_list` VALUES (2017090203, 50000012, 170601000, '2023-12-11', '2023-12-11');
INSERT INTO `lend_list` VALUES (2017090204, 50000012, 170601000, '2023-12-11', '2023-12-11');
INSERT INTO `lend_list` VALUES (2017090205, 50000012, 170601000, '2023-12-12', '2023-12-11');
...
CREATE TABLE `reader_info`  (
  `reader_id` int(0) NOT NULL COMMENT '卡号',
  `name` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '姓名',
  ...
  `telcode` varchar(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '电话'
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `reader_info` VALUES (1706010300, 'ganzong', '男', '2023-12-10', '广东', '13413811599');
INSERT INTO `reader_info` VALUES (1706010220, 'ganzong', '男', '2023-12-10', '广东', '13413811599');
INSERT INTO `reader_info` VALUES (1706010240, 'aganaa', '男', '2023-12-30', '广东', '13413811594');
INSERT INTO `reader_info` VALUES (2006010217, 'qq', '男', '2023-12-31', '广东', '13413811599');
INSERT INTO `reader_info` VALUES (2110005288, 'aa', '男', '1998-09-10', '广东', '13413811599');
INSERT INTO `reader_info` VALUES (0, 'agan', '男', '2023-12-11', '广东', '13413811599');
INSERT INTO `reader_info` VALUES (0, 'agan', '男', '2023-12-11', '广东', '13413811599');
INSERT INTO `reader_info` VALUES (0, 'xf', '男', '2023-12-17', '广东', '13413811594');
INSERT INTO `reader_info` VALUES (0, 'wxf', '男', '2023-12-24', '广东', '12345678912');
INSERT INTO `reader_info` VALUES (170601000, 'qy', '男', '2023-12-23', '广东', '13413811594');
INSERT INTO `reader_info` VALUES (115155, 'aganaa', '男', '2023-12-28', '广东', '13413811599');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('0918', '123', 'user');
INSERT INTO `user` VALUES ('1006010217', '123', 'user');
INSERT INTO `user` VALUES ('115155', '123', 'user');
INSERT INTO `user` VALUES ('170601000', '123', 'user');
...
INSERT INTO `user` VALUES ('2110005288', '123456', 'user');
INSERT INTO `user` VALUES ('admin', '1234567', 'admin');
INSERT INTO `user` VALUES ('gan', '123456', 'user');
